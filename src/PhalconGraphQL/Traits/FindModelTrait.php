...
{
    public function _find(array $args, Field $field)
    {
        $id = $args['id'];
    ...
    protected function _beforeHandleFind($id, array $args, Field $field)
    {
    }

    protected function _getFindData($id, array $args, Field $field)
    {
    ...
    protected function _modifyFindQuery(QueryBuilder $query, $id, array $args, Field $field)
    {
    }
    ...
    protected function _getFindResponse($item, array $args, Field $field)
    {
        return $item;
    }

    protected function _afterHandleFind($item, $response, array $args, Field $field)
    {
    }
}